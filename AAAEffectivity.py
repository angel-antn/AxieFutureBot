...
button_grupo2_e=InlineKeyboardButton(text="Es de tipo Alba", callback_data="ataque_grupo2_e")
...
def ataque_grupo2_e(update, context):

    query=update.callback_query
    query.answer()

    query.edit_message_text(text="¿Que sea de tipo Alba influye en algo?, pues si tu axie es tipo Alba la historia cambia...\n\n"\
